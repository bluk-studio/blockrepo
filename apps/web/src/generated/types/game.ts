...
// @generated from protobuf file "types/game.proto" (package "bluk.games", syntax proto3)
// tslint:disable
 ...
 * @type Game
 *
 * @generated from protobuf message bluk.games.Game
 */
export interface Game {
    ...
    thumbnail?: string;
    /**
     * @generated from protobuf field: optional bluk.games.User creator = 5;
     */
    creator?: User;
    /**
    ...
    tags: string[];
    /**
     * @generated from protobuf field: bluk.games.Game.LandingPageConfig landingPageConfig = 7;
     */
    landingPageConfig?: Game_LandingPageConfig;
}
/**
 * @generated from protobuf message bluk.games.Game.LandingPageConfig
 */
export interface Game_LandingPageConfig {
    /**
     * @generated from protobuf field: repeated bluk.games.Game.LandingPageConfig.HeaderLink headerLinks = 1;
     */
 ...
 * Header links
 *
 * @generated from protobuf message bluk.games.Game.LandingPageConfig.HeaderLink
 */
...
class Game$Type extends MessageType<Game> {
    ...
    internalBinaryWrite(message: Game, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* optional bluk.games.User creator = 5; */
        if (message.creator)
        ...
        /* bluk.games.Game.LandingPageConfig landingPageConfig = 7; */
...
class Game_LandingPageConfig$Type extends MessageType<Game_LandingPageConfig> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Game_LandingPageConfig): Game_LandingPageConfig {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated bluk.games.Game.LandingPageConfig.HeaderLink headerLinks */ 1:
    ...
    internalBinaryWrite(message: Game_LandingPageConfig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated bluk.games.Game.LandingPageConfig.HeaderLink headerLinks = 1; */
...
/**
 * @generated MessageType for protobuf message bluk.games.Game.LandingPageConfig
 */
...
class Game_LandingPageConfig_HeaderLink$Type extends MessageType<Game_LandingPageConfig_HeaderLink> {
    constructor() {
        super("bluk.games.Game.LandingPageConfig.HeaderLink", [
...
/**
 * @generated MessageType for protobuf message bluk.games.Game.LandingPageConfig.HeaderLink
 */
