 ...
 *
 * @generated from protobuf message grpc.reflection.v1alpha.ServerReflectionRequest
 */
export interface ServerReflectionRequest {
    ...
    messageRequest: {
         ...
         *
         * @generated from protobuf field: grpc.reflection.v1alpha.ExtensionRequest file_containing_extension = 5;
         */
 ...
 *
 * @generated from protobuf message grpc.reflection.v1alpha.ExtensionRequest
 */
 ...
 *
 * @generated from protobuf message grpc.reflection.v1alpha.ServerReflectionResponse
 */
export interface ServerReflectionResponse {
    ...
    validHost: string;
    /**
     * @generated from protobuf field: grpc.reflection.v1alpha.ServerReflectionRequest original_request = 2;
     */
    ...
    messageResponse: {
         ...
         *
         * @generated from protobuf field: grpc.reflection.v1alpha.FileDescriptorResponse file_descriptor_response = 4;
         */
         ...
         *
         * @generated from protobuf field: grpc.reflection.v1alpha.ExtensionNumberResponse all_extension_numbers_response = 5;
         */
         ...
         *
         * @generated from protobuf field: grpc.reflection.v1alpha.ListServiceResponse list_services_response = 6;
         */
         ...
         *
         * @generated from protobuf field: grpc.reflection.v1alpha.ErrorResponse error_response = 7;
         */
 ...
 * request.
 *
 * @generated from protobuf message grpc.reflection.v1alpha.FileDescriptorResponse
 */
 ...
 *
 * @generated from protobuf message grpc.reflection.v1alpha.ExtensionNumberResponse
 */
 ...
 *
 * @generated from protobuf message grpc.reflection.v1alpha.ListServiceResponse
 */
export interface ListServiceResponse {
     ...
     *
     * @generated from protobuf field: repeated grpc.reflection.v1alpha.ServiceResponse service = 1;
     */
 ...
 *
 * @generated from protobuf message grpc.reflection.v1alpha.ServiceResponse
 */
 ...
 *
 * @generated from protobuf message grpc.reflection.v1alpha.ErrorResponse
 */
...
class ServerReflectionRequest$Type extends MessageType<ServerReflectionRequest> {
    constructor() {
        super("grpc.reflection.v1alpha.ServerReflectionRequest", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string file_containing_symbol */ 4:
                    ...
                    break;
                case /* grpc.reflection.v1alpha.ExtensionRequest file_containing_extension */ 5:
                    message.messageRequest = {
                        oneofKind: "fileContainingExtension",
...
/**
 * @generated MessageType for protobuf message grpc.reflection.v1alpha.ServerReflectionRequest
 */
...
class ExtensionRequest$Type extends MessageType<ExtensionRequest> {
    constructor() {
        super("grpc.reflection.v1alpha.ExtensionRequest", [
...
/**
 * @generated MessageType for protobuf message grpc.reflection.v1alpha.ExtensionRequest
 */
...
class ServerReflectionResponse$Type extends MessageType<ServerReflectionResponse> {
    constructor() {
        super("grpc.reflection.v1alpha.ServerReflectionResponse", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string valid_host */ 1:
                    ...
                    break;
                case /* grpc.reflection.v1alpha.ServerReflectionRequest original_request */ 2:
                    message.originalRequest = ServerReflectionRequest.internalBinaryRead(reader, reader.uint32(), options, message.originalRequest);
                    break;
                case /* grpc.reflection.v1alpha.FileDescriptorResponse file_descriptor_response */ 4:
                    ...
                    break;
                case /* grpc.reflection.v1alpha.ExtensionNumberResponse all_extension_numbers_response */ 5:
                    message.messageResponse = {
                        oneofKind: "allExtensionNumbersResponse",
                    ...
                    break;
                case /* grpc.reflection.v1alpha.ListServiceResponse list_services_response */ 6:
                    message.messageResponse = {
                        oneofKind: "listServicesResponse",
                    ...
                    break;
                case /* grpc.reflection.v1alpha.ErrorResponse error_response */ 7:
                    message.messageResponse = {
                        oneofKind: "errorResponse",
...
/**
 * @generated MessageType for protobuf message grpc.reflection.v1alpha.ServerReflectionResponse
 */
...
class FileDescriptorResponse$Type extends MessageType<FileDescriptorResponse> {
    constructor() {
        super("grpc.reflection.v1alpha.FileDescriptorResponse", [
...
/**
 * @generated MessageType for protobuf message grpc.reflection.v1alpha.FileDescriptorResponse
 */
...
class ExtensionNumberResponse$Type extends MessageType<ExtensionNumberResponse> {
    constructor() {
        super("grpc.reflection.v1alpha.ExtensionNumberResponse", [
...
/**
 * @generated MessageType for protobuf message grpc.reflection.v1alpha.ExtensionNumberResponse
 */
...
class ListServiceResponse$Type extends MessageType<ListServiceResponse> {
    constructor() {
        super("grpc.reflection.v1alpha.ListServiceResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListServiceResponse): ListServiceResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated grpc.reflection.v1alpha.ServiceResponse service */ 1:
...
/**
 * @generated MessageType for protobuf message grpc.reflection.v1alpha.ListServiceResponse
 */
...
class ServiceResponse$Type extends MessageType<ServiceResponse> {
    constructor() {
        super("grpc.reflection.v1alpha.ServiceResponse", [
...
/**
 * @generated MessageType for protobuf message grpc.reflection.v1alpha.ServiceResponse
 */
export const ServiceResponse = new ServiceResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ErrorResponse$Type extends MessageType<ErrorResponse> {
    constructor() {
        super("grpc.reflection.v1alpha.ErrorResponse", [
...
/**
 * @generated MessageType for protobuf message grpc.reflection.v1alpha.ErrorResponse
 */
export const ErrorResponse = new ErrorResponse$Type();
/**
 * @generated ServiceType for protobuf service grpc.reflection.v1alpha.ServerReflection
 */
export const ServerReflection = new ServiceType("grpc.reflection.v1alpha.ServerReflection", [
