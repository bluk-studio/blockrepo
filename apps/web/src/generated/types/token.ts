...
// @generated from protobuf file "types/token.proto" (package "bluk.games", syntax proto3)
// tslint:disable
 ...
 * Token message
 *
 * @generated from protobuf message bluk.games.Token
 */
export interface Token {
    ...
    id: string;
    /**
     * @generated from protobuf field: bluk.games.TokenType type = 2;
     */
    type: TokenType;
    /**
    ...
    entityId: string;
    /**
     * @generated from protobuf field: repeated bluk.games.Permission permissions = 4;
     */
 ...
 * AuthToken
 *
 * @generated from protobuf message bluk.games.AuthToken
 */
 ...
 * TokenType enum
 *
 * @generated from protobuf enum bluk.games.TokenType
 */
...
class Token$Type extends MessageType<Token> {
    constructor() {
        super("bluk.games.Token", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "type", kind: "enum", T: () => ["bluk.games.TokenType", TokenType] },
            { no: 3, name: "entityId", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "permissions", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["bluk.games.Permission", Permission] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    ...
                    break;
                case /* bluk.games.TokenType type */ 2:
                    message.type = reader.int32();
                    break;
                case /* string entityId */ 3:
                    message.entityId = reader.string();
                    break;
                case /* repeated bluk.games.Permission permissions */ 4:
    ...
    internalBinaryWrite(message: Token, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* bluk.games.TokenType type = 2; */
        if (message.type !== 0)
            writer.tag(2, WireType.Varint).int32(message.type);
        /* string entityId = 3; */
        if (message.entityId !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.entityId);
        /* repeated bluk.games.Permission permissions = 4; */
...
/**
 * @generated MessageType for protobuf message bluk.games.Token
 */
export const Token = new Token$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AuthToken$Type extends MessageType<AuthToken> {
    constructor() {
        super("bluk.games.AuthToken", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message bluk.games.AuthToken
 */
