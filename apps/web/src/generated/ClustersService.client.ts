 ...
 *
 * @generated from protobuf service bluk.games.ClustersService
 */
export interface IClustersServiceClient {
    /**
     * @generated from protobuf rpc: GetAll(bluk.games.EmptyRequest) returns (bluk.games.GetAllResponse);
     */
 ...
 *
 * @generated from protobuf service bluk.games.OneClusterService
 */
export interface IOneClusterServiceClient {
    /**
     * Servers-related
     *
     * @generated from protobuf rpc: GetAllServers(bluk.games.EmptyRequest) returns (bluk.games.GetAllServersResponse);
     */
    getAllServers(input: EmptyRequest, options?: RpcOptions): UnaryCall<EmptyRequest, GetAllServersResponse>;
    /**
     * @generated from protobuf rpc: CreateServer(bluk.games.CreateServerRequest) returns (bluk.games.Server);
     */
    createServer(input: CreateServerRequest, options?: RpcOptions): UnaryCall<CreateServerRequest, Server>;
    /**
     * Cluster's Health related
     *
     * @generated from protobuf rpc: GetClusterHealth(bluk.games.EmptyRequest) returns (bluk.games.ClusterHealth);
     */
    getClusterHealth(input: EmptyRequest, options?: RpcOptions): UnaryCall<EmptyRequest, ClusterHealth>;
    /**
     * @generated from protobuf rpc: SendServerHealth(bluk.games.SendServerHealthRequest) returns (bluk.games.ServerHealth);
     */
