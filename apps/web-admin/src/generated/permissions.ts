 ...
 * Requests/Responses
 *
 * @generated from protobuf message bluk_games.GetUserPermissionsRequest
 */
...
/**
 * @generated from protobuf message bluk_games.GetUserPermissionsResponse
 */
...
class GetUserPermissionsRequest$Type extends MessageType<GetUserPermissionsRequest> {
    constructor() {
        super("bluk_games.GetUserPermissionsRequest", [
...
/**
 * @generated MessageType for protobuf message bluk_games.GetUserPermissionsRequest
 */
...
class GetUserPermissionsResponse$Type extends MessageType<GetUserPermissionsResponse> {
    constructor() {
        super("bluk_games.GetUserPermissionsResponse", [
            { no: 1, name: "permissions", kind: "enum", repeat: 1 /*RepeatType.PACKED*/, T: () => ["Permission", Permission] }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message bluk_games.GetUserPermissionsResponse
 */
export const GetUserPermissionsResponse = new GetUserPermissionsResponse$Type();
/**
 * @generated ServiceType for protobuf service bluk_games.PermissionService
 */
export const PermissionService = new ServiceType("bluk_games.PermissionService", [
