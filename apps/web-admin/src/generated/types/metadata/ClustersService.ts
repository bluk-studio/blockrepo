...
// @generated from protobuf file "types/metadata/ClustersService.proto" (syntax proto3)
// tslint:disable
...
export interface GetAllResponse {
    /**
     * @generated from protobuf field: repeated GameCluster clusters = 1;
     */
 ...
 *
 * @generated from protobuf message GetAllServersResponse
 */
export interface GetAllServersResponse {
    /**
     * @generated from protobuf field: repeated Server servers = 1;
     */
    servers: Server[];
}
/**
 * @generated from protobuf message CreateServerRequest
 */
...
/**
 * @generated from protobuf message SendServerHealthRequest
 */
export interface SendServerHealthRequest {
    ...
    id: string;
    /**
     * @generated from protobuf field: ServerHealth health = 2;
     */
    health?: ServerHealth;
}
...
class GetAllResponse$Type extends MessageType<GetAllResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetAllResponse): GetAllResponse {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* repeated GameCluster clusters */ 1:
...
class GetAllServersResponse$Type extends MessageType<GetAllServersResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetAllServersResponse): GetAllServersResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated Server servers */ 1:
...
/**
 * @generated MessageType for protobuf message GetAllServersResponse
 */
...
/**
 * @generated MessageType for protobuf message CreateServerRequest
 */
...
/**
 * @generated MessageType for protobuf message SendServerHealthRequest
 */
